...
: Base SI units.\index{Base units}
...
: Derived SI units.\index{Derived units}
...
### Unity Fraction\index{Unity fraction}
...
1.  Use unity fraction\index{Unity fraction} to convert between derived SI units.
...
Read introduction in [@russellAppliedMechanicsMarine2021] and complete the end of chapter problems.
